...
categories: ["Robotics"]
---
![result](/image/densevio_result.png)
...
![The proposed processing pipeline for depth recovery.](/image/densevio_system.gif)
...
![The comparisons between dense mapping results.](/image/densevio_result_1.gif)
